local Library = loadstring(game:HttpGet("https://raw.githubusercontent.com/vvvchaos/rizz/refs/heads/main/rizz.lua"))()

local Window = Library:New({
    Name = "punjabi.ware", -- name, Name, title, Title
})
...
local Page = Window:Page({
    Name = "punjab" -- name, Name, title, Title
})
